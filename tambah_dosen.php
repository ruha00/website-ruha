...
<?php
    if (isset($_POST['simpan'])) {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO tbl_dosen VALUES('$nidn','$nama','$alamat','$agama','$tgl_lahir','$id_prodi', '$id_mk')");
        ...
        if ($query) {
            ...
            echo "<script>location='index.php?hal=tambah_dosen'</script>";
        }
    }
    ?>